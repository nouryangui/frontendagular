...
export class MemberListComponent implements OnInit {
  ...
  displayedColumns: string[] = ['id', 'Cin', 'FirstName', 'LastName', 'Date Of Birth', 'Email', 'CV', "actions"];
  totalPages: number;
  currentPage: number;
  protected _onDestroy = new Subject<void>();


  constructor(private memberService: MemberService, private matDialog: MatDialog) { }
